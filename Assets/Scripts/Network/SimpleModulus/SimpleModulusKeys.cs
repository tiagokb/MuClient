...
public class SimpleModulusKeys
{
    ...
    {
        return
            $"Encryption Key: {this.ModulusKey[0]}, {this.ModulusKey[1]}, {this.ModulusKey[2]}, {this.ModulusKey[3]}, {this.EncryptKey[0]}, {this.EncryptKey[1]}, {this.EncryptKey[2]}, {this.EncryptKey[3]}, {this.XorKey[0]}, {this.XorKey[1]}, {this.XorKey[2]}, {this.XorKey[3]}"
